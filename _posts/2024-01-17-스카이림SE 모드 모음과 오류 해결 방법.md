...
|| [SE] Unofficial SSE Patch Korean  | | <https://drive.google.com/file/d/10-fJ3gumo-vHVHJ3xEqpAeVukSTjLhEI/view?usp=sharing> ||
...
| 사진 | 증상 | 해결 방법 |
|:---|:---|:---|
|<details><img src="assets/img/posts/af9kh57aci_1.png"></details>|크리에이션 킷을 모드 오거나이저에 연결할때 Application load error V:0000065432 오류|사진처럼 1946180을 입력한후 저장시 정상적으로 작동한다|
|<details><img src="assets/img/posts/af9kh57aci_2.png"></details>|크리에이션 킷 multiple master files selected for load. load operation aborted 오류|<https://www.nexusmods.com/skyrimspecialedition/mods/36986> 파일을 다운받아 크리에이션 킷이 설치된 폴더로 옮긴다|
