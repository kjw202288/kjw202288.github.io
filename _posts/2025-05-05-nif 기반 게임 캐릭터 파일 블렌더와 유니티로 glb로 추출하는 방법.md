...
3. 스카이림의 경우 바디의 메시는 ~_0.nif를 아머의 메시는 ~_1.nif를 추출하고 여성 캐릭터의 경우 ~f_1.nif를 추출한다 폴아웃의 경우 여성 캐릭터의 경우 아머의 메시는 female~.nif를 추출한다 아머의 텍스쳐는 .dds, _m.dds, _n.dds 등을 추출한다
